...
function autenticar(email, senha) {
    ...
    var instrucaoSql = `
        SELECT idUsuario, nome, email, tipoUsuario, idEmpresa, empresa.status FROM usuario join empresa on idEmpresa = fkEmpresa WHERE email = '${email}' AND senha = SHA2('${senha}', 256);
    `;
